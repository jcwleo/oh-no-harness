---
name: plan-reviewer
description: Use proactively inside active Oh No Harness workflows only when Ralplan's planning phase reviews the exact Planner draft; the caller owns approval and handoff gates.
...
<!-- Source: plugins/oh-no-harness/docs/agent-core/plan-reviewer.md -->
