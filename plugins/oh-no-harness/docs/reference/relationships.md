...
configure-subagents
  ...
  -> after final confirmation, OpenCode calls oh_no_configure_subagents once with all nine exact provider/model IDs; the plugin tool writes separate opencode-subagent-models.conf preferences without Bash or a helper path
